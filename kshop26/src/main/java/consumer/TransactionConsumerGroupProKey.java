...
public class TransactionConsumerGroupProKey<K, V> {
  private final KafkaConsumer<K, V> consumer;

  TransactionConsumerGroupProKey(KafkaConsumer<K, V> consumer) {
  ...
  public static void main(String[] args) {
    ...
    var myConsumer = new TransactionConsumerGroupProKey<>(consumer);
